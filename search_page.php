...
<section class="management" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
     ...
     $select_management = $conn->prepare("SELECT * FROM `management` WHERE name LIKE '%{$search_box}%'"); 
   ...
   <form action="" method="post" class="box">
      ...
      <a href="quick_view.php?pid=<?= $fetch_management['id']; ?>" class="fas fa-eye"></a>
      <img src="uploaded_img/<?= $fetch_management['image_01']; ?>" alt="">
      <div class="name"><?= $fetch_management['name']; ?></div>
      <div class="flex">
         <div class="year"><span>$</span><?= $fetch_management['year']; ?><span>/-</span></div>
